...
**Scope.** 278 files / ~82,420 lines. Covers everything in the working tree except: the
...
| `CHANGELOG.md` | 1348 | prose changelog newest-first: a large unreleased section over v1.4 back to v0.1, feature by feature | docs | active |
...
| `src/backupviewer/api.py` | 4719 | the pywebview bridge class: 117 @_endpoint methods returning {ok,data} envelopes across every feature area | shared/infra | active |
...
| `src/backupviewer/web/js/tabs/home.js` | 3112 | the #home library screen: plant/line/robot tree, per-row actions, batch ftp backup, discover, cam tiles | library | active |
